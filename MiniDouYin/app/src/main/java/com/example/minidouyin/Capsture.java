...
import com.example.minidouyin.tool.ResourceUtils;
...
import static com.example.minidouyin.tool.Utils.MEDIA_TYPE_IMAGE;
import static com.example.minidouyin.tool.Utils.MEDIA_TYPE_VIDEO;
import static com.example.minidouyin.tool.Utils.getOutputMediaFile;
        ...
        if (resultCode == RESULT_OK && null != data) {
            if (requestCode == PICK_IMAGE) {
                ...
                Call<PostVideoResponse> postVideoResponseCall = retrofit.
                        create(Service.class).post("3180109999", "admin", coverImage, video);
